...
// time an artist, album, or library is removed — opusflow owns the copy it
// made, so unlike the old scan-in-place model there's no safe default: the
// reviewer picks explicitly, every time, rather than either choice being
// assumed.
export default function RemoveModal({
  name,
  description = "This removes it from your library. You can also delete opusflow's copy of these files from disk — your choice, every time.",
  onDeleteFiles,
  onKeepFiles,
  onCancel,
  submitting,
