...
func New(staticDir, artworkDir, version, buildDate string, svc *library.Service) http.Handler {
	...
	mux.HandleFunc("POST /api/library/artists/{id}/photos/{photoId}/primary", handleSetGalleryPrimary(artistGalleryRoutes(svc)))
	mux.HandleFunc("POST /api/library/artists/{id}/photos/{photoId}/banner", handleSetGalleryBanner(artistGalleryRoutes(svc)))
	...
	mux.HandleFunc("POST /api/library/albums/{id}/covers/{coverId}/primary", handleSetGalleryPrimary(albumGalleryRoutes(svc)))
	mux.HandleFunc("POST /api/library/albums/{id}/covers/{coverId}/banner", handleSetGalleryBanner(albumGalleryRoutes(svc)))
