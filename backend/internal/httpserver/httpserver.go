...
func New(staticDir, artworkDir, version, buildDate string, svc *library.Service) http.Handler {
	...
	mux.HandleFunc("POST /api/library/artists/{id}/photos/{photoId}/primary", handleSetArtistPrimaryPhoto(svc))
	mux.HandleFunc("DELETE /api/library/artists/{id}/photos/{photoId}", handleDeleteArtistPhoto(svc))
	...
	mux.HandleFunc("POST /api/library/albums/{id}/covers/{coverId}/primary", handleSetAlbumPrimaryCover(svc))
	mux.HandleFunc("DELETE /api/library/albums/{id}/covers/{coverId}", handleDeleteAlbumCover(svc))
