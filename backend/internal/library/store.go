...
// it via SetImages to enable saving embedded cover art at scan time
// (AC-1); until then, InsertTrack silently skips any artwork a track
// carries rather than failing the import over it.
